...
const Signup = () => {
	...
	const onSubmit = async () => {
		await axios
			.post('https://back.highthon10.kro.kr/auth/signup', {
				loginId: input.id,
	...
	return (
		<Container>
			...
			<Signin_Input>
				...
				<Sextoggle_Layout>
					<Sextoggle_Container_male sex={input.sex}>
						<Sextoggle_Button_male
							sex={input.sex}
							name='sex'
							onClick={onClickSexMale}
						>
							남자
						</Sextoggle_Button_male>
				...
				<Button_Layout>
					<Button_Container>
						<Button_Button onClick={onSubmit}>회원가입</Button_Button>
					</Button_Container>
				</Button_Layout>
